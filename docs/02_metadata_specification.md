...
### Pillar Codes
`A` (SSS Firm), `B` (Afro-Indian-American Strategic Minerals and Capital Corridor (Afro-Indian-American Strategic Trade Alliance (Afro-Indian-American Strategic Trade Alliance (AISTA)) Corridor)), `C` (Corleone), `multiple`, `none`

### Portfolio Entity Codes
`SSTLC`, `BIBC`, `Sovereign SafeTrade Program (SSTP)`, `Afro-Indian-American Strategic Trade Alliance (Afro-Indian-American Strategic Trade Alliance (AISTA)) Corridor`, `CORLEONE`, `DVPO`, `SSS`, `none`
